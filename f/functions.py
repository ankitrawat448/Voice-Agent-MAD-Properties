...
from rag_engine import search_knowledge_base as _rag_search
...
FUNCTION_DEFINITIONS = [
    ...
    },
    {
        ...
        "description": (
            "Search MAD Apartments' official policy documents for complaint-related "
            "questions. Use this when a tenant asks WHAT qualifies as an emergency, "
            "HOW LONG repairs take, WHAT their rights are, HOW to escalate a complaint, "
            "WHO is responsible for a repair, or WHAT the noise/pest/damp policy is. "
            "Do NOT use this for filing a complaint — use file_complaint for that."
        ),
        "parameters": {
            "type": "object",
            "properties": {
                "query": {
                    "type": "string",
                    "description": (
                        "The tenant's question rephrased as a clear search query, "
                        "e.g. 'what counts as a plumbing emergency' or "
...
FUNCTION_MAP = {
    ...
    "search_knowledge_base":    _rag_search,
}
